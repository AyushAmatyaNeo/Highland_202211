(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        var deleteEmpSalSheLink=data['links']['deleteEmpSalSheLink'];
...
//                    console.log(response);
        ...
        var actionColumn = {
            ...
            <a class="btn-delete hris-delete-salarysheet" title="Delete" sheet-no="#: SHEET_NO #" employee-id="#: EMPLOYEE_ID #" style="height:17px;margin-left:1rem;"> <i class="fa fa-trash-o"></i></a>`
...
//            }
        ...
        $('#hris-page-content').on('click', '.hris-delete-salarysheet', function () {
            var $this = $(this);
            var employeeId = $this.attr('employee-id');
            var sheetNo = $this.attr('sheet-no');
            var salarySheet = app.findOneBy(salarySheetList, {SHEET_NO: sheetNo});
            var monthId = salarySheet['MONTH_ID'];
            app.serverRequest(deleteEmpSalSheLink, {
                employeeId: employeeId,
                monthId: monthId,
                sheetNo: sheetNo,
            }).then(function (response) {
