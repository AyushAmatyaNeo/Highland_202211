(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        app.initializeKendoGrid($table, [
            ...
            {field: "IN_TIME", title: "Check In" ,width: 100, template: "<span>#: (IN_TIME == null) ? '-' : IN_TIME # </span>"},
            {field: "OUT_TIME", title: "Check Out",width: 100, template: "<span>#: (OUT_TIME == null) ? '-' : OUT_TIME # </span>"},
            {field: "IN_REMARKS", title: "In Remarks" ,width: 100,},
            {field: "OUT_REMARKS", title: "Out Remarks" ,width: 100,},
//            
            {field: "RECOMMENDER", title:"Recommender" ,width: 100,},
            {field: "APPROVER", title:"Approver" ,width: 100,},

            {field: "STATUS", title: "Status", template: "<span>#: (STATUS == null) ? '-' : STATUS # </span>"},
            {title: 'Shift Details', columns: [
                    {field: "SHIFT_ENAME", title: "Name" ,width: 100,},
                    {field: "START_TIME", title: "From" ,width: 100,},
                    {field: "END_TIME", title: "To",width: 100,},
                ]}
