(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        var columns = [
            ...
            {field: "FULL_NAME", title: "Employee",  template: "<span>#: (FULL_NAME == null) ? '-' : FULL_NAME #</span>" ,width: 100,},
            {title: "Requested Date",
                columns: [{
                        field: "REQUESTED_DT_AD",
                        title: "AD", 
                        template: "<span>#: (REQUESTED_DT_AD == null) ? '-' : REQUESTED_DT_AD #</span>", width: 100,},
                    {field: "REQUESTED_DT_BS",
                        title: "BS",
                        template: "<span>#: (REQUESTED_DT_BS == null) ? '-' : REQUESTED_DT_BS #</span>",width: 100,}]},
            {title: "Attendance Date",
                columns: [{
                        field: "ATTENDANCE_DT_AD",
                        title: "AD",
                        template: "<span>#: (ATTENDANCE_DT_AD == null) ? '-' : ATTENDANCE_DT_AD #</span>",width: 100,},
                    {field: "ATTENDANCE_DT_BS",
                        title: "BS",
                        template: "<span>#: (ATTENDANCE_DT_BS == null) ? '-' : ATTENDANCE_DT_BS #</span>",width: 100,}]},
            {field: "IN_TIME", title: "Check In", template: "<span>#: (IN_TIME == null) ? '-' : IN_TIME #</span>",width: 100,},
            {field: "OUT_TIME", title: "Check Out", template: "<span>#: (OUT_TIME == null) ? '-' : OUT_TIME #</span>" ,width: 100,},
            {field: "IN_REMARKS", title: "In Remarks" ,width: 100,},
            {field: "OUT_REMARKS", title: "Out Remarks",width: 100,},
            {field: "RECOMMENDER_NAME", title: "Recommender" ,width: 100,},
            {field: "APPROVER_NAME", title: "Approver",width: 100,},
