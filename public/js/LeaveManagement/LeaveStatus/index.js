(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        var columns = [ 
            {field: "EMPLOYEE_CODE", title: "Code",width: 70,},
            {field: "FULL_NAME", title: "Employee",width: 70,},
            {field: "LEAVE_ENAME", title: "Leave",width: 70,},
            {title: "Requested Date",
                columns: [{
                        field: "APPLIED_DATE_AD",
                        title: "AD",
                        template: "<span>#: (APPLIED_DATE_AD == null) ? '-' : APPLIED_DATE_AD #</span>" ,width: 70,},
                    {field: "APPLIED_DATE_BS",
                        title: "BS",
                        template: "<span>#: (APPLIED_DATE_BS == null) ? '-' : APPLIED_DATE_BS #</span>" ,width: 70,}]},
            {title: "From Date",
                columns: [{
                        field: "START_DATE_AD",
                        title: "AD",
                        template: "<span>#: (START_DATE_AD == null) ? '-' : START_DATE_AD #</span>" ,width: 70,},
                    {field: "START_DATE_BS",
                        title: "BS",
                        template: "<span>#: (START_DATE_BS == null) ? '-' : START_DATE_BS #</span>" ,width: 70,}]},
            {title: "To Date",
                columns: [{
                        field: "END_DATE_AD",
                        title: "AD",
                        template: "<span>#: (END_DATE_AD == null) ? '-' : END_DATE_AD #</span>",width: 70,},
                    {field: "END_DATE_BS",
                        title: "BS",
                        template: "<span>#: (END_DATE_BS == null) ? '-' : END_DATE_BS #</span>",width: 70,}]},
            {field: "NO_OF_DAYS", title: "Duration" ,width: 70,},
            {field: "HALF_DAY_DETAIL", title: "Type" ,width: 70,},
            {field: "RECOMMENDER_NAME", title: "RECOMMENDER" ,width: 70,},
            {field: "APPROVER_NAME", title: "APPROVER" ,width: 70,},
